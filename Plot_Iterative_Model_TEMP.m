...
subplot(2,1,1)
hold on
plot([0 num_msmt*max_iter], [J2_truth J2_truth], 'r', 'linewidth', 2);
plot(0,J2_estInit,"xr");
plot(1:num_msmt*max_iter, J2_estHistPlot);
...
hold on
plot(1:num_msmt*max_iter,err_histPlot)
hold off
